...
export function Hero() {
  return (
    <div className="h-screen w-full rounded-md flex md:items-center md:justify-center bg-gradient from-black/[0.96] to-black antialiased bg-grid-white/[0.02] relative overflow-hidden">
      <Spotlight />
